...
class SecurityMiddleware:
    ...
    def __call__(self, environ: Dict[str, Any], start_response: Callable) -> Any:
        ...
        # 检查CSRF (对于状态更改请求)
        if not blocked and 'csrf' in self.filters and request_data['method'] not in ('GET', 'HEAD', 'OPTIONS'):
