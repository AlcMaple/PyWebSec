...
class TestMiddleware(unittest.TestCase):
    ...
    def test_parse_request_data(self):
        """测试请求数据解析功能"""
        # 创建一个测试请求环境
        form_data = b"form1=formvalue1&form2=formvalue2"
        environ = {
            "REQUEST_METHOD": "POST",
        ...
        self.assertEqual(
            request_data["query_params"], {"query1": "value1", "query2": "value2"}
        )
        self.assertEqual(
            request_data["form_data"], {"form1": "formvalue1", "form2": "formvalue2"}
        )
        self.assertEqual(
